...
# We need to insert the products just before the closing </div> of <div class="products__grid" id="products-grid" role="list">
# Let's find the products grid closing tag by searching for <!-- CARRINHO DE ORÇAMENTOS --> or similar.
# Wait, actually let's just find the last </article> and put it after that.
last_article_pos = html.rfind('</article>')
...
if last_article_pos != -1:
    ...
    new_html = html[:last_article_pos + 10] + articles_html + html[last_article_pos + 10:]
